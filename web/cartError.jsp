...
<html>
    ...
    <center>
        <div class="container">
            <center><h1>Your Cart is Already Full!</h1></center>

            <h2>Please click the button below to go back and remove a movie from your cart.</h2>

            <a href=customer.jsp><button>Customer Page</button></a>
